...
namespace Project.Tests
{
    public class InventoryModelTests
    {
        ...
        public void Setup()
        {
            ...
            m_PotionItem.MaxStack = 3;
            
            m_SwordItem = ScriptableObject.CreateInstance<InventoryItemSO>();
            m_PotionItem.name = "Sword";
            m_PotionItem.MaxStack = 5;
        }
        ...
        {
            // Arrange
            m_InventoryModel.TryAddItem(m_PotionItem, 1);
            m_InventoryModel.TryAddItem(m_SwordItem, 1);
